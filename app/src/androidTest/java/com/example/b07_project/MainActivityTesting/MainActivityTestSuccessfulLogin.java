...
public class MainActivityTestSuccessfulLogin {

    @Rule
    public ActivityTestRule<MainActivity> mActivityTestRule = new ActivityTestRule<>(MainActivity.class);

    @Test
    public void mainActivityTestSuccessfulLogin() {
        ViewInteraction appCompatEditText = onView(
                Matchers.allOf(ViewMatchers.withId(R.id.userEmailAddress),
                        childAtPosition(
                                childAtPosition(
